...
\begin{document}
	...
	\begin{enumerate}[label=\thesection.\arabic*
		...
		\end{lstlisting}
		\begin{figure}[!htp]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/1_1.png}
			\caption{$x(t)$}
			\label{fig:xt}
		\end{figure}
	...
	\begin{enumerate}[label=\thesection.\arabic*,ref=\thesection.\theenumi]
		...
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/2_3.png}
		...
		\end{lstlisting}
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/2_6.png}
	...
	\begin{enumerate}[label=\thesection.\arabic*
		...
		\end{lstlisting}
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/3_8.png}
		...
		\end{lstlisting}
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/3_9.png}
		...
		\end{lstlisting}
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/3_10.png}
	...
	\begin{enumerate}[label=\thesection.\arabic*
		...
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/4_3.png}
	...
	\begin{enumerate}[label=\thesection.\arabic*
		...
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/5_1.png}
		...
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/5_2.png}
			\caption{Chebyshev response for various $n$.}
			\label{fig:cheby-resp}
		\end{figure}
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/charger/figs/5_3.png}
