...
\begin{document}
	...
	\begin{enumerate}[label=\arabic*.,ref=\thesection.\theenumi]
		...
		\begin{figure}[!ht]
			\centering
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/cktsig/figs/ckts.jpg}
			\caption{}
			\label{fig:ckt}
		\end{figure}
		\item Find $q_1$.
		...
		\begin{figure}[!htb]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/cktsig/figs/2.6.png}
	...
	\begin{enumerate}[label=\arabic*.,ref=\thesection.\theenumi]
		...
		\end{lstlisting}
		\begin{figure}[!htb]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/cktsig/figs/3.4.png}
	...
	\begin{enumerate}[label=\arabic*.,ref=\thesection.\theenumi]
		...
		\end{lstlisting}
		\begin{figure}[!ht]
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/cktsig/figs/4.3.png}
			\caption{Plot of $H(s)$.}
			\label{fig:Hs}
		\end{figure}
		...
		\end{lstlisting}
		\begin{figure}
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/cktsig/figs/4.7.png}
