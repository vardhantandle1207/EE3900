...
\begin{document}
	...
	\begin{enumerate}[label=\thesection.\arabic*,ref=\thesection.\theenumi]
		...
		\begin{figure}[!htp].png
			\includegraphics[width=\columnwidth]{/home/vardhan/Downloads/EE3900-2022-main/pingala/figs/2_1.png}
			\caption{Plot of $x(n)$}
			\label{fig:xn}
		\end{figure}
		...
		\end{lstlisting}
		\begin{figure}[!htbp]
			\includegraphics[width=\columnwidth]{//home/vardhan/Downloads/EE3900-2022-main/pingala/figs/2_2.png}
			\caption{Plot of $y(n)$}
			\label{fig:yn}
		\end{figure}
		\item Find $Y^{+}(z)$. 
